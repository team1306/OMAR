...
\begin{center} \texttt{2014 Scouting Sheet by \textsc{CrowdScout}} \end{center}

\vspace*{-.7cm}

\begin{center}\large FRC Wisconsin Regional March 20\textsuperscript{th} - March 20\textsuperscript{th}\end{center}
...
\fbox{\noindent\begin{minipage}{\linewidth} % Pyramid Goal Frisbees
  ...
  (leave blank if robot didn't start with a ball)
  \begin{multicols}{3}
    \checkBox{autoShot.0}{A}{Didn't shoot}\newline
    \checkBox{autoShot.1}{B}{Unsuccessful attempt}\newline
    \checkBox{autoShot.2}{C}{Made goal}\nextcolumn
    \checkBox{autoShot.3}{D}{Made hot goal} 
  \end{multicols}
\end{minipage}}
\\
